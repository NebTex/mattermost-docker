...
DB_HOST={{ printf "Settings/%s/AppRoles/%s/DB/HOST" (env "NAMESPACE") (env "APP_NAME") | key }} 
DB_PORT={{ printf "Settings/%s/AppRoles/%s/DB/PORT" (env "NAMESPACE") (env "APP_NAME") | key }} 
